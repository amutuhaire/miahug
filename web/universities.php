        ...
        <div class="container"><a class="navbar-brand" href="index.php">MIah</a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="universities.php" class="nav-link">Universities</a></li>
            ...
            <div class="row">
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        <a href="mukhostels.php" class="img" style="background-image: url(img/muk.jpg);"></a>
                        <div class="text p-4">
                            <h3><a href="mukhostels.php">Makerere</a></h3>
