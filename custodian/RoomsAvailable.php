    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">The table show all the rooms in the hostel including which is available or not for allocation</p>
                  ...
                  <?php
                   ...
                   ?>
                    <tr>
                      ...
                      <td><?php echo $rows['occupation_status']; ?></td>
                      <td><?php echo $rows['no_of_occupants']; ?></td>
                    </tr>
                    <?php
                      }
                    ?>
